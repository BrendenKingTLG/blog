...
export default function Index() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Make a POST request to your backend API route to send the subscription email
    try {
      ...
      if (response.ok) {
        // Subscription email sent successfully, you can handle success here
        console.log("Subscription email sent successfully");
      } else {
        // Handle error when the subscription email fails to send
